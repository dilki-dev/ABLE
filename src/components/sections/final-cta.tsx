    ...
    <section className="relative overflow-hidden bg-[#f97316] py-16 text-white sm:py-20">
      ...
      <Reveal className="site-container relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex shrink-0 flex-col gap-3 sm:flex-row lg:flex-col">
          <a href={config.phoneHref} className="motion-lift inline-flex items-center justify-center gap-2 rounded-xl bg-[#111111] px-6 py-4 text-sm font-extrabold"><Phone aria-hidden="true" className="h-4 w-4" /> Call ABLE</a>
          <a href="#contact" className="final-cta-quote-button motion-lift inline-flex items-center justify-center gap-2 rounded-xl px-6 py-4 text-sm font-extrabold">Request a quote <ArrowRight aria-hidden="true" className="h-4 w-4" /></a>
        </div>
      </Reveal>
    </section>
  );

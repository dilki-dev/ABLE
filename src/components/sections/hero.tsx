...
export function Hero({ business, content }: { business: SiteContent["business"]; content: SiteContent["hero"] }) {
  ...
  return (
    <section id="top" className="relative isolate min-h-[680px] overflow-hidden bg-[#111111] text-white">
      <Image src={content.image} alt="Property maintenance professional repairing a modern home in Sri Lanka" fill priority sizes="100vw" className="-z-20 object-cover object-[66%_center]" />
      ...
      <div className="site-container flex min-h-[680px] items-center py-20">
        <div className="max-w-3xl">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            ...
            <a href={config.whatsappUrl} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/30 bg-white/10 px-6 py-4 text-sm font-extrabold text-white backdrop-blur transition hover:border-green-400 hover:bg-green-600"><MessageCircle aria-hidden="true" className="h-4 w-4" /> WhatsApp</a>
          </div>

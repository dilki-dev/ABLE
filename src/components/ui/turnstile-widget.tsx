...
export function TurnstileWidget({ siteKey, action }: { siteKey: string; action: "quote" | "admin-login" }) {
  ...
  return <><Script src="https://challenges.cloudflare.com/turnstile/v0/api.js" strategy="afterInteractive" /><div className="cf-turnstile min-h-[140px] max-w-full" data-sitekey={siteKey} data-action={action} data-theme="auto" data-size="compact" /></>;
}

...
export function MobileMenu({ business, navigation, homeLinks = false }: { business: SiteContent["business"]; navigation: SiteContent["navigation"]; homeLinks?: boolean }) {
  ...
  return (
    <div className="lg:hidden">
      ...
      {open ? (
        <div ref={menuRef} id="mobile-navigation" className="absolute inset-x-0 top-full max-h-[calc(100dvh-76px)] overflow-y-auto border-t border-[#e7e7e3] bg-white p-5 shadow-2xl">
